...
const abroadPlaces = [
  ...
  { src: "https://images.unsplash.com/photo-1513635269975-59663e0ac1ad?w=800", alt: "London skyline", label: "United Kingdom", href: "/study-abroad" },
  { src: "https://images.unsplash.com/photo-1523482580672-f109ba8cb9be?w=800", alt: "Sydney opera house", label: "Australia", href: "/study-abroad" },
  { src: "https://images.unsplash.com/photo-1467269204594-9661b134dd2b?w=800", alt: "German castle", label: "Germany", href: "/study-abroad" },
  { src: "https://images.unsplash.com/photo-1549893072-4bc678117f45?w=800", alt: "Dublin street", label: "Ireland", href: "/study-abroad" },
  { src: "https://images.unsplash.com/photo-1502602898657-3e91760cbb34?w=800", alt: "Paris Eiffel Tower", label: "France", href: "/study-abroad" },
  { src: "https://images.unsplash.com/photo-1507699622108-4be3abd695ad?w=800", alt: "New Zealand mountains", label: "New Zealand", href: "/study-abroad" },
  { src: "https://images.unsplash.com/photo-1530122037265-a5f1f91d3b99?w=800", alt: "Swiss alps", label: "Switzerland", href: "/study-abroad" },
  { src: "https://images.unsplash.com/photo-1512453979798-5ea266f8880c?w=800", alt: "Dubai skyline", label: "UAE (Dubai)", href: "/study-abroad" },
];
