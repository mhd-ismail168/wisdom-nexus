                    ...
                    >
                        ...
                        <div className="flex-1 w-full">
                            <div className="flex items-center gap-4 mb-2">
                                ...
                                <h3 className="text-2xl md:text-3xl font-serif-heading text-[var(--color-text-primary)] tracking-wide">{country.name}</h3>
                            </div>
                                ...
                                <motion.div variants={contentStagger} initial="hidden" animate="visible" exit="hidden" className="p-8 md:p-12 space-y-16">
                                    ...
                                    <motion.div variants={subsectionReveal} className="flex flex-col md:flex-row gap-8 lg:gap-12 items-start relative z-10">
                                        ...
                                        <div className="flex-1 w-full pt-2">
                                            <h2 className="text-3xl md:text-4xl font-serif-heading text-[var(--color-text-primary)] tracking-wide leading-tight mb-4">
                                    ...
                                    <motion.div variants={subsectionReveal} className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 relative z-10">
                                        ...
                                        <div className="relative z-10 bg-[var(--color-surface)] p-8 border border-[var(--color-border)]">
                                            <h3 className="flex items-center gap-3 text-xl font-serif-heading text-[var(--color-text-primary)] mb-6 tracking-wide">
                                        ...
                                        <div className="relative z-10">
                                            ...
                                            <div className="flex flex-col gap-6 bg-[var(--color-surface)] p-6 sm:p-8 border border-[var(--color-border)] relative overflow-hidden">
                                                <div className="relative z-10">
                                                    ...
                                                    <span className="text-xl font-serif-heading text-[var(--color-text-primary)] tracking-wide">{country.tuition}</span>
                                                </div>
                                                ...
                                                <div className="relative z-10">
                                                    ...
                                                    <span className="text-xl font-serif-heading text-[var(--color-text-primary)] tracking-wide">{country.living}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </motion.div>
                                    ...
                                    <motion.div variants={subsectionReveal} className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 relative z-10">
                                        {/* Top Universities */}
                                        <div className="relative z-10">
                                            <h3 className="flex items-center gap-3 text-xl font-serif-heading text-[var(--color-text-primary)] mb-8 tracking-wide pl-2">
                                        ...
                                        <div className="flex flex-col gap-10 relative z-10">
                                            ...
                                            <div className="bg-[var(--color-surface)] p-8 border border-[var(--color-border)] relative overflow-hidden">
                                                <h3 className="flex items-center gap-3 text-xl font-serif-heading text-[var(--color-text-primary)] mb-6 tracking-wide relative z-10">
                                    ...
                                    <motion.div variants={subsectionReveal} className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-stretch relative z-10">
                                        {/* Work & Visa */}
                                        <div className="bg-[var(--color-surface)] p-8 border border-[var(--color-border)] relative overflow-hidden">
                                            <h3 className="flex items-center gap-3 text-xl font-serif-heading text-[var(--color-text-primary)] mb-8 tracking-wide relative z-10">
                                        ...
                                        <div className="flex flex-col gap-4 justify-center bg-[var(--color-bg-primary)] p-8 md:p-10 border border-[var(--color-border)] text-center lg:text-left h-full">
                                            <h4 className="text-xl font-serif-heading text-[var(--color-text-primary)]">Ready to start your journey?</h4>
